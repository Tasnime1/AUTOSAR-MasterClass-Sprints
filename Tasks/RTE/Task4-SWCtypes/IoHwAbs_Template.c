...
void IoHwAbs_ECUGet_Height (IoPositionSensorReadingType* IoWeightPositionReadingType_position)
{
...
void IoHwAbs_ECUGet_Incline (IoPositionSensorReadingType* IoWeightPositionReadingType_position)
{
	Std_ReturnType status;
...
void IoHwAbs_ECUGet_Slide (IoPositionSensorReadingType* IoWeightPositionReadingType_position)
{
	Std_ReturnType status;
...
void IoHwAbs_ECUGet_Weight (IoWeightSensorReadingType* IoWeightSensorReadingType_weight)
{
	Std_ReturnType status;
